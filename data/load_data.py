...
def load_CIFAR10(batch_size_tr=128, batch_size_val=128, batch_size_test=128,
    ...
    train_dataloader = DataLoader(train_set, batch_size=batch_size_tr, shuffle=True)
    val_dataloader = DataLoader(val_set, batch_size=batch_size_val, shuffle=False)
...
def load_CIFAR10_small(batch_size_tr=128, batch_size_val=128, batch_size_test=128,
    ...
    train_dataloader = DataLoader(train_set, batch_size=batch_size_tr, shuffle=True)
    val_dataloader = DataLoader(val_set, batch_size=batch_size_val, shuffle=False)
    test_dataloader = DataLoader(test_set, batch_size=batch_size_test, shuffle=False)
