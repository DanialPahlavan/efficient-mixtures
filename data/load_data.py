...
def load_mnist(batch_size_tr=128, batch_size_val=128, batch_size_test=128, split_seed=42):
    ...
    train_dataloader = DataLoader(train, batch_size=batch_size_tr, shuffle=True, num_workers=16, pin_memory=True)
    ...
    val_dataloader = DataLoader(val, batch_size=batch_size_val, shuffle=True, num_workers=16, pin_memory=True)
    ...
    test_dataloader = DataLoader(test, batch_size=batch_size_test, shuffle=True, num_workers=16, pin_memory=True)
...
def load_CIFAR10(batch_size_tr=128, batch_size_val=128, batch_size_test=128,
    ...
    train_dataloader = DataLoader(train_set, batch_size=batch_size_tr, shuffle=True, num_workers=16, pin_memory=True)
    val_dataloader = DataLoader(val_set, batch_size=batch_size_val, shuffle=False, num_workers=16, pin_memory=True)
    test_dataloader = DataLoader(test_dataset, batch_size=batch_size_test, shuffle=False, num_workers=16, pin_memory=True)
...
def load_CIFAR10_small(batch_size_tr=128, batch_size_val=128, batch_size_test=128,
    ...
    train_dataloader = DataLoader(train_set, batch_size=batch_size_tr, shuffle=True, num_workers=16, pin_memory=True)
    val_dataloader = DataLoader(val_set, batch_size=batch_size_val, shuffle=False, num_workers=16, pin_memory=True)
    test_dataloader = DataLoader(test_set, batch_size=batch_size_test, shuffle=False, num_workers=16, pin_memory=True)
